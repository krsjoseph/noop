...
//
// The Apple-Fitness-x-WHOOP look scaled to the wrist: the three Kineva rings (Charge / Effort / Rest) with
...
// one-line sleep summary. When nothing has synced yet we show a friendly "open Kineva on your iPhone" state,
    ...
    private var emptyState: some View {
        VStack(spacing: 10) {
            Image(systemName: "iphone.gen3")
                .font(.system(size: 28))
                .foregroundStyle(StrandPalette.textTertiary)
            Text("Open Kineva on your iPhone to sync")
...
// MARK: - ScoreRing — one clean Kineva ring scaled for the wrist
//
