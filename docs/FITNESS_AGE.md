...
It is computed **on-device**, weekly, from data Kineva already has. Nothing is sent anywhere.
...
mapped onto a 0–7.5 scale. Kineva doesn't ask the user to fill that in. Instead it **reconstructs the
