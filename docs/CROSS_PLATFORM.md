...
Kineva ships three clients. They look different and are written in two languages, but they implement the
...
the OS integrations — but the strap protocol, the math, and your data are the same Kineva underneath.*
