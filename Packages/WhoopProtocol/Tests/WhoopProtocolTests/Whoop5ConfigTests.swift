...
/// what Kineva's own `puffinCommandFrame` emits — so a regression in either the framing or the flag table
...
final class Whoop5ConfigTests: XCTestCase {
    ...
    /// The built frame must round-trip through Kineva's own 5.0 frame verifier (CRC16 header + CRC32 tail),
