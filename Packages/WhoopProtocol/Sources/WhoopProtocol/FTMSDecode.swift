...
//
// Spec-deterministic field parsing for the four FTMS machine-data characteristics Kineva reads live:
...
// Supplement" characteristic field tables. Kineva's own clean re-implementation of the public spec.
