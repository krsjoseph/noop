...
// We decode the fields Kineva surfaces in a live workout (speed, cadence, power, and the cumulative
...
// 1.0, "Cycling Power Service" 1.1, and the GATT Specification Supplement field tables. Kineva's own clean
