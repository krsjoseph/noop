...
extension WhoopStore {
    ...
    static func makeMigrator() -> DatabaseMigrator {
        ...
        // CBPeripheral.identifier.uuidString (iOS/Mac) so Kineva can tell physical straps apart and
        ...
        // (their own report's range, shown back verbatim). Kineva ships no reference-range tables and
