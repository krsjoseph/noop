...
public struct ActivityFile: Sendable, Equatable {
    ...
    public var end: Date
    /// Brand/sport label as the file named it (e.g. "running", "Biking"). Normalized to a Kineva sport
...
public enum ActivityFileImporter {
    ...
    /// Kineva-style Title-Cased label; an unknown/absent sport becomes the neutral "Activity" (we never
