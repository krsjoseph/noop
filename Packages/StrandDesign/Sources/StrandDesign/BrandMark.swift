...
// MARK: - BrandMark — the Kineva logo mark (Titanium & Gold)
//
...
//
// It reads as the "O" in Kineva and as a small echo of the hero recovery ring.
...
public struct BrandMark: View {
    ...
    public var body: some View {
        ...
        .accessibilityLabel(Text("Kineva"))
