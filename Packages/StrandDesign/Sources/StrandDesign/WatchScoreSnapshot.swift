...
public struct WatchScoreSnapshot: Codable, Equatable, Sendable {
    ...
    /// Effort (strain) on Kineva's 0 to 100 axis. `nil` when there is no usable HR window for the day.
    ...
    public static let appGroupId = "group.com.aretetechnologies.kineva"
