...
//     Kineva has no questionnaire, so it RECONSTRUCTS each factor from measured weekly signals.
...
public enum FitnessAgeEngine {
    ...
    /// PA-index (0–15) from Kineva's measured weekly load — the UNIVERSAL path the orchestrator uses
