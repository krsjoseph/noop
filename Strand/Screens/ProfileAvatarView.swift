...
//
// LOCAL-ONLY: the photo lives in UserDefaults on this device and is never uploaded (Kineva is
...
struct ProfileAvatarView: View {
    ...
    var body: some View {
        if let image = decodedImage {
            ...
            // Fallback: the Kineva loop BrandMark (the green ring + white core) instead of a generic
