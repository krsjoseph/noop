...
struct LiveView: View {
    ...
    private var sessionPrompt: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text(activeConnection
                 ? "Start a workout when the stream matters. Kineva records the interval, HR, peak, average and effort from the same live feed."
    ...
    // The connect / buzz / disconnect controls, all routed through the unified Kineva button system:
