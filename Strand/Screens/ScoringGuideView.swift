...
// MARK: - Scoring guide
//
// "How your scores work" — the one honest explainer for Kineva's three daily scores
    ...
    private var confidenceCard: some View {
        NoopCard {
            VStack(alignment: .leading, spacing: 12) {
                Text("How sure is Kineva?  ·  Solid · Building · Calibrating")
                ...
                Text("Every score carries a small honesty label. Calibrating means Kineva is still learning your baseline, or doesn't have enough data yet. Building means there's enough to show, but it's thin. Solid means full inputs are present. When Kineva can't compute a score honestly, it shows nothing rather than a fake number.")
                    .font(StrandFont.subhead)
                    .foregroundStyle(StrandPalette.textSecondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
