...
struct StorageView: View {
        ...
        return StrandCard {
            VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                ...
                Text(reclaimable > 0
                     ...
                     : "Nothing to reclaim right now — Kineva already cleans up import scratch space automatically.")
    ...
    private var explainerCard: some View {
        DataPendingNote(
            ...
            message: "When you import an Apple Health or WHOOP export, iOS hands Kineva a private copy of the file. Kineva reads it, saves your data into the health database, then deletes the copy. Older builds didn't delete every copy — this screen reclaims any that were left behind.",
