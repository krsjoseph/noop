...
struct CaffeineLogCard: View {
    ...
    // when enabled, Kineva works back from the user's bedtime by the dose's decay lead and flags any logged
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            NoopCard(tint: StrandPalette.accent) {
                VStack(alignment: .leading, spacing: 10) {
                    Text("Log a coffee, tea, or energy drink and Kineva shows a rough estimate of how much may still be active. It's a guide based on a typical 5 to 6 hour half-life, not a measurement.")
