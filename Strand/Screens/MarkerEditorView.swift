...
// free-text — NEVER a Kineva-shipped range. Blood pressure is a PAIRED marker (systolic +
...
// shown back verbatim — Kineva defines no ranges and asserts no normality.
        ...
        VStack(alignment: .leading, spacing: NoopMetrics.gap) {
            ...
            NoopCard {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    Text("Kineva never fills this in — it only shows back exactly what you type from your own report.")
                        .font(StrandFont.footnote)
                        .foregroundStyle(StrandPalette.textTertiary)
