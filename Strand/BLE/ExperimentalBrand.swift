...
public enum ExperimentalBrand: String, CaseIterable, Sendable, Equatable {
    ...
    /// "Broadcast Heart Rate" on the watch — there is no Kineva-proprietary Garmin protocol.
    case garmin
    ...
    /// Whether this brand can stream LIVE heart rate at all in Kineva's experimental tier. `false` for Oura
