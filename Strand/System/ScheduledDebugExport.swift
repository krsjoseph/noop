...
///
/// Opt-in, default OFF — like every Kineva automation. Everything is on-device; nothing is sent anywhere.
@MainActor
enum ScheduledDebugExport {
    ...
    static let bgTaskIdentifier = "com.aretetechnologies.kineva.debugexport"
