...
struct IOSDiagnostics {
    ...
    /// macOS: best-effort "is this a signed plus notarized build". Kineva's macOS build is intentionally
    ...
    /// Honest signing/notarization probe. Kineva's macOS build ships unsigned for anonymity, so this is
