...
struct RawHistoryArchive {
    /// File name under `<AppSupport>/com.aretetechnologies.kineva/`.
    ...
    /// Default location: `<AppSupport>/com.aretetechnologies.kineva/`, created on demand. Overridable for tests.
    init(directory: URL? = nil,
        ...
        if let directory {
            ...
            self.directory = base.appendingPathComponent("com.aretetechnologies.kineva", isDirectory: true)
        }
