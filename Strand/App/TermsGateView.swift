            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        Text("The full terms are in TERMS.md, shipped with Kineva. This is not legal advice.")
                            .font(StrandFont.footnote)
                ...
                VStack(spacing: 16) {
                    Toggle(isOn: $checked) {
                        Text("I have read and accept these terms, and I'm using Kineva with my own device and my own data, at my own risk.")
                            .font(StrandFont.footnote)
                            .foregroundStyle(StrandPalette.textPrimary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
