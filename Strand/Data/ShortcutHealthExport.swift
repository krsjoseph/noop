...
/// Kineva drops a plain-text file at Documents/noop_sync.txt (exposed to Files/Shortcuts via
...
enum ShortcutHealthExport {
    ...
    /// Opt-in gate (default OFF — every automation in Kineva is optional).
