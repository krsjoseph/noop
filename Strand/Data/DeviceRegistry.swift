...
final class DeviceRegistry: ObservableObject {
    ...
    /// Archive (remove) a device: Kineva stops connecting to it, but its recorded data is kept. If the
    ...
    /// CBPeripheral.identifier.uuidString on iOS/Mac. Lets Kineva tell physical straps apart and map a
