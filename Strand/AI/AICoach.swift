...
//
// Kineva is offline by design. This file is the single exception: when the user pastes their OWN
// API key for a provider they choose, Kineva can send a compact text summary of their metrics plus
