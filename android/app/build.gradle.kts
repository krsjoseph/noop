...
android {
    ...
    //   • full → "Kineva"      (com.aretetechnologies.kineva)      — the real app, starts empty, pair a strap / import.
    //   • demo → "Kineva Demo" (com.aretetechnologies.kineva.demo) — preloaded with 120 days of synthetic data and
