...
/**
 * #528 — the importer must NOT re-ingest records Kineva itself wrote to Health Connect. Without this,
 * turning on "share back" and then importing would re-read Kineva's own daily totals and sum them on
...
class HealthConnectSelfWriteSkipTest {
    ...
    private val self = "com.aretetechnologies.kineva"
    ...
    @Test fun keepsRecordsFromOtherSources() {
        ...
        assertFalse(HealthConnectImporter.isSelfWritten("com.aretetechnologies.kineva.demo", self)) // different pkg
    }
