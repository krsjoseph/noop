 ...
 * Kineva's nightly HRV ([HrvAnalyzer.rmssdRaw], Task Force 1996, sample (n-1) denominator), so a spot
...
class SpotHrvReadingTest {
    ...
    /** Textbook RMSSD with the Task Force (1996) SAMPLE denominator (n-1) — the reference Kineva uses. */
