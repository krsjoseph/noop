 ...
 *      returns totalSleepMin=null on EVERY day. Kineva does NOT hallucinate a 12h "721" from a motionless
...
class Issue547RepeatRepro {
    ...
    fun offWristTableBlock_repeatsSameTotalAcrossEveryDay() {
        ...
        //     So Kineva does NOT hallucinate a 12h "721" sleep from a motionless strap; pikapik's 721 is
