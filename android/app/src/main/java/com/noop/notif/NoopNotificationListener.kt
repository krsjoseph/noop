 ...
 *
 * Declaring this service (with BIND_NOTIFICATION_LISTENER_SERVICE in the manifest) is what makes Kineva
 * appear in Android's **Notification Access** list at all (issue #52 — before this, the "Open
 * Notification Access" button opened a list Kineva wasn't in). When the user grants access, Android binds
