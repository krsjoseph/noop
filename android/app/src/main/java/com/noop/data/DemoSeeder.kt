...
object DemoSeeder {
    ...
    // The Kineva-COMPUTED strap source ("<strap>-noop") the IntelligenceEngine persists its derived weekly
    ...
    private suspend fun seed(repo: WhoopRepository) {
        ...
        for (i in 0 until DAYS) {
            ...
            // Seed under the Kineva-COMPUTED source (WHOOP_NOOP), exactly where the IntelligenceEngine writes
