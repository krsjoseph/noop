 ...
 * people on Reddit saw the strap disconnect the moment they closed Kineva. A started foreground
...
class WhoopConnectionService : Service() {
    ...
    /**
     * Watches the OS Bluetooth radio so turning it off immediately tears down Kineva's orphaned GATT
    ...
    private fun ensureChannel() {
        ...
        runCatching {
            ...
            val channel = NotificationChannel(
                ...
                description = "Shown while Kineva keeps your WHOOP connected in the background."
                setShowBadge(false)
