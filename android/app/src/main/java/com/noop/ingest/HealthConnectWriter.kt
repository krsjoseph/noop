...
/**
 * OPT-IN writeback: pushes Kineva's on-device computed nightly metrics (resting HR, HRV RMSSD, sleep
 ...
 *    (or loop our own import). What Kineva computed from the strap is genuinely ours to contribute.
...
object HealthConnectWriter {
    ...
    /**
     * #528 — export Kineva's heart-rate samples (raw [deviceId], not computed) above the persisted
