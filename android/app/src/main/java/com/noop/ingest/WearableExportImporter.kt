 ...
 *
 * Maps onto Kineva's DAILY metrics + sleep sessions (NOT workouts). HONEST DATA: only fields the export
 * carries are written; a brand's OWN score (Oura "readiness", a sleep score) is stored under a
 * reference metricSeries key only — NEVER as Kineva's Charge/Effort/Rest. Every row is written under the
 ...
 *
 * LICENSE: the file shapes are DOCUMENTED format facts. No GPL/AGPL code is copied — Kineva's own code.
 */
