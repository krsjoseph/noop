...
/**
 * Pure (Android-free, HC-SDK-free) planning logic for what Kineva exports INTO Health Connect.
 *
 ...
 * metrics Kineva genuinely computed — daily steps, active energy, heart-rate series, sleep sessions —
 * into Health Connect for other apps. Honest: only days/samples Kineva actually has are emitted; a
...
object HealthExportPlan {
     ...
     *  matches what the rest of Kineva already considers asleep. */
