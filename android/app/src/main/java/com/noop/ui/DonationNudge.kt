...
//
// A small, dismissible card that asks — at most once every 12 hours — whether Kineva is
// proving useful, and makes the honest economic case for a donation: a WHOOP membership
// costs $300–480 a year, Kineva is free and built by one person, and almost nobody donates.
//
    ...
    NoopCard(tint = Palette.accent) {
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text("Enjoying Kineva?", style = NoopType.headline, color = Palette.textPrimary)
            }
            Text(
                "A WHOOP membership runs $300–480 a year, for life. Kineva does this for free — " +
