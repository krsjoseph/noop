...
object TrendsReportRenderer {
    ...
    fun renderPdf(
        ...
        val file = File(dir, "Kineva-trends-${report.start}_to_${report.end}.pdf")
    ...
    private fun drawHeader(canvas: Canvas, report: RangeReport, range: ReportRange, top: Float): Float {
        ...
        val left = MARGIN + 16f
        var ty = cardTop + 26f
        text(canvas, "Kineva", left, ty, 11f, sansBold, ACCENT, letterSpacing = 0.12f)
    ...
    private fun drawFooter(canvas: Canvas, generatedOn: String) {
        ...
        // Provenance legend (#457): make clear which numbers are measured vs. Kineva's own derived scores,
        ...
        val legend = "How to read this: HRV, Resting HR, Sleep duration, Respiratory rate and Skin " +
            ...
            "Strain and Stress are Kineva's own on-device scores, not clinical measures — Recovery is a daily " +
        ...
        text(
            canvas,
            "Generated by Kineva on $generatedOn · all on-device, no account, no cloud.",
    ...
    fun export(
        ...
        runCatching {
            ...
            val send = Intent(Intent.ACTION_SEND).apply {
                ...
                putExtra(Intent.EXTRA_SUBJECT, "Kineva trends report")
