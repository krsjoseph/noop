...
/**
 * How the Effort score is displayed (#268). Kineva stores Effort 0–100 (StrainScorer.maxStrain = 100);
...
enum class EffortScale(val raw: String) {
    ...
    companion object {
        /** An unset/unknown value resolves to Kineva's native 0–100 axis. */
...
object UnitFormatter {
    ...
    /**
     * Kineva stores Effort 0–100 (StrainScorer.maxStrain = 100). WHOOP's Day Strain axis is 0–21, and the
