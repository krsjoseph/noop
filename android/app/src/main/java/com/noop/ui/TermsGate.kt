...
object Terms {
    ...
    val points: List<Pair<String, String>> = listOf(
        "Independent — not affiliated with WHOOP" to
            "Kineva is an unofficial project — not affiliated with, endorsed by, or sponsored by WHOOP, Inc. \"WHOOP\" is their trademark, used only to name the hardware Kineva works with.",
        "Using Kineva may breach WHOOP's Terms of Service" to
        ...
        "Experimental — at your own risk" to
            "Kineva talks to your strap's firmware over an unofficial, independently-mapped protocol. There is a residual risk to the device, its data, and its connection to official services. You assume that risk.",
        "Not a medical device, not medical advice" to
            "Every metric is an unvalidated approximation. Don't use Kineva to diagnose, treat, or make any health decision. Always consult a qualified professional.",
        "No warranty; liability limited" to
            "Kineva is free and provided \"as is\", with no warranty. Liability is limited to the maximum extent the law that applies to you allows — and nothing here removes protections your local law won't let us remove.",
    )
}
...
fun TermsGateScreen(onAccept: () -> Unit) {
    ...
    Surface(modifier = Modifier.fillMaxSize(), color = Palette.surfaceBase) {
        Column(modifier = Modifier.fillMaxSize().padding(horizontal = 24.dp)) {
            ...
            Text("Before you use Kineva", style = NoopType.title1, color = Palette.textPrimary)
            ...
            Column(
                ...
                Text(
                    "The full terms are in TERMS.md, shipped with Kineva. This is not legal advice.",
            ...
            Row(verticalAlignment = Alignment.Top) {
                ...
                Text(
                    "I have read and accept these terms, and I'm using Kineva with my own device and my own data, at my own risk.",
