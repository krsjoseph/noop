 ...
 * foreground Activity. The full-screen intent re-opens Kineva; on a locked screen the system promotes
    ...
    private fun ensureChannel(context: Context) {
        ...
        runCatching {
            ...
            val channel = NotificationChannel(
                ...
                description = "The phone wake alarm Kineva fires inside your chosen wake window."
