 ...
 *
 * This wraps Kineva's canonical [HrvAnalyzer] for the LIVE, user-triggered HRV snapshot the Live screen
 ...
 *  - Kineva's nightly HRV (`avgHrv`, fed into Vitality / Fitness Age) uses [HrvAnalyzer.rmssdRaw], which
...
object SpotHrvReading {
     ...
     * capture window. Runs Kineva's canonical cleaning + RMSSD (range filter -> Malik ectopic rejection
