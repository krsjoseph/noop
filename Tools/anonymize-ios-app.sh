...
# your username. Kineva ships anonymously, so this must be stripped from every Mach-O in the
...
#     Tools/anonymize-ios-app.sh build/ios-dd/Build/Products/Release-iphoneos/Kineva.app
#
# os.walk below recurses the WHOLE bundle, so the embedded watch app (Kineva.app/Watch/KinevaWatch.app)
